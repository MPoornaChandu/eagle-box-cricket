...
export const demoFixtures: Fixture[] = [
  {
    ...
    fours: 18,
    sixes: 7,
    notes: "Eagle Warriors controlled the chase with disciplined middle overs.",
    result: {
      teamARuns: 168,
      teamAWickets: 6,
      teamAOvers: "20.0",
  ...
  },
  {
    ...
    fours: 21,
    sixes: 5,
    notes: "Hyderabad Titans chased with eight balls remaining.",
    result: {
      teamARuns: 142,
      teamAWickets: 9,
      teamAOvers: "20.0",
  ...
  },
  {
    ...
    teamBOvers: "15.0",
    resultType: "Tie",
    playerOfMatch: "Dev Menon",
    fours: 16,
    sixes: 4,
    notes: "Tie after a last-ball two. Points update is pending.",
    result: {
      teamARuns: 132,
      teamAWickets: 7,
      teamAOvers: "15.0",
...
export const demoActivities: ActivityItem[] = [
  {
    ...
    message: "EBC-003 result saved. Tie recorded between Coastal Kings and Skyline Riders.",
